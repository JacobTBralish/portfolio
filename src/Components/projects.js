  ...
  return (
    <div className="projectsContainer">
      <section className="projectsTopHeaderContainer">
        <h1 className="projectTopHeader">
          Recent projects: Samples of Projects I have created to showcase and
